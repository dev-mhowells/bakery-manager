...
export default function BakeryIndex() {
    ...
    {/* cards that contain 3 elements */}
                    ...
                    <Link for="/addItem"><button class="btn bg-beige text-bone btn-block">Add more items</button></Link>
                            ...
                            <Link for="/login"><label htmlFor="my-modal" className="btn text-bone bg-beige btn-block" onClick={ClearLocalStorage()}>Logout</label></Link>
    {/* calendar */}
